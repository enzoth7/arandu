    ...
    try {
      ...
      const payload = mode === "register"
        ? {
            ...
            facilityId: selectedType === "elepem" ? (typeof selectedFacilityId === "string" && selectedFacilityId.startsWith("DEMO-") ? selectedFacilityId : Number(selectedFacilityId)) : undefined,
            termsAccepted,
          }
        : mode === "password"
