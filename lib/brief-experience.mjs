  ...
  privacy: {
    outstanding: {
      resident: {
        ...
        visit_rules: "Los horarios y las reglas facilitan especialmente el contacto con familiares y personas allegadas.",
        personal_objects: "Tengo plena libertad para llevar objetos personales y decorar mi dormitorio.",
      },
      family: {
        room_entry: "Siempre avisan y esperan su permiso antes de entrar a su habitación.",
    ...
    good: {
      resident: {
        ...
        personal_objects: "Puedo llevar objetos personales y decorar mi dormitorio, aunque existen algunas limitaciones.",
      },
      family: {
        ...
        visit_rules: "Los horarios y las reglas permiten mantener el contacto con familiares y personas allegadas.",
        personal_objects: "Puede llevar objetos personales y decorar su dormitorio, aunque existen algunas limitaciones.",
      },
    },
    requires_improvement: {
      resident: {
      ...
      family: {
        room_entry: "A veces entran a su habitación sin avisar o sin esperar su permiso.",
    ...
    inadequate: {
      ...
      family: {
        room_entry: "Entran a su habitación sin avisar ni pedirle permiso.",
