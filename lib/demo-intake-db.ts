    ...
    const result = await withSupabaseTransaction(async (client) => {
      const inserted = await client.query<{ id: string }>(
        `INSERT INTO public.intake_reports (
           ...
           entry_type, is_demo, demo_facility_id, facility_id, payload_version,
           submitted_actor, current_status, submitted_by_user_id
         ) VALUES ($1, 'web', $2, $3, $4::jsonb, $5, $6, $7, $8, $9, $10, $11, $12::uuid)
