...
// los ordenamientos son alfabéticos o administrativos y explicables. No existe
// ranking general, puntaje de calidad, estrellas ni prioridad por pago.
...
export function facilityStageRank(facility) {
  ...
  return 4;                                     // Sin situación localizada
}
...
/**
 * Filtra por texto libre, departamento, localidad, situación administrativa y
 * estado de tratamiento interno. Los criterios vacíos no filtran.
 *
