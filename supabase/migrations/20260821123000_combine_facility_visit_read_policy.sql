...
drop policy if exists "Visitors can read their own visits" on public.facility_visits;
drop policy if exists "Representatives can read visits for active memberships" on public.facility_visits;

create policy "Users can read authorized visits"
